...
const RouteOptimization = () => {
  ...
  const [startPoint, setStartPoint] = useState({ latitude: 21.1458, longitude: 79.0882 }); // Nagpur
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-gray-800 mb-2">Select Destinations</h2>
            <p className="text-sm text-gray-600">Choose villages to include in the optimized route</p>
          </div>
                ...
                {route.route.map((stop, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      {index === 0 && (
                        <p className="text-sm text-blue-600 font-semibold">Starting Point (Nagpur)</p>
                      )}
                    </div>
                  </motion.div>
                ))}
